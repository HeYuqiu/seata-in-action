...
import com.hyq.service.OrderService;
...
import com.hyq.service.OrderServiceImpl;
...
public class OrderController {
    ...
    @PostMapping("/create")
    public Integer createOrder(@RequestParam("userId") Long userId, @RequestParam("productId") Long productId,
